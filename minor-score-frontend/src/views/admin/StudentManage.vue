    ...
    >
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="年级" prop="grade">
          <el-input v-model="formData.grade" placeholder="如：2022级" />
        </el-form-item>
      </el-form>
      <template #footer>
...
import {
  getStudentList, addStudent, updateStudent, deleteStudent,
  getCollegeList
} from '../../api'
...
const loadData = async () => {
  try {
    const res = await getStudentList({ page: pagination.page, size: pagination.size })
...
const resetForm = () => {
  Object.assign(formData, {
    id: null, studentNo: '', username: '', password: '',
    realName: '', gender: 1, phone: '', email: '', collegeId: null, grade: ''
  })
